...
\end{tabular}\end{center}
\[ \text{cut}=\frac{104-3.71}{104}=\mathbf{96.4\,\%}\ \ge 40\,\%\quad\Rightarrow\quad \ok \]
Hand-checked: $45.0+104/28=48.71$\,B/record. \textbf{The last row is the co-design argument in
...
optimised on both ISAs) while BLS needs $3.25\times$ (heavily x86-tuned). \textbf{Consequence: the
docs/04 §1 ``5--15$\times$'' anchor is unreachable} for an equally-optimised primitive and must be
restated per-cycle.
...
ed25519 sign & \textbf{70.62} & 70.11--71.24 & 0.771 \\
ed25519 verify & \textbf{186.84} & 184.37--188.38 & 0.712 \\
ecdsa sign & 87.29 & 86.73--88.69 & 0.630 \\
ecdsa verify & 203.51 & 201.77--206.80 & 0.617 \\
bls sign & 1464.61 & 1442.80--1489.06 & 0.514 \\
bls verify & 5121.91 & 5068.33--5205.19 & 0.520 \\
delta encode & 36.19 & 35.89--36.60 & 0.726 \\
cbor encode & 40.11 & 39.65--40.58 & 0.753 \\ \bottomrule
\end{tabular}\end{center}
...
\textbf{bls:verify is 14.4\,\% off} and is flagged for investigation under Law 7 (sustained 60\,s
loop versus the micro suite's short bursts is the leading hypothesis). Measured
$p_{cpu}$ median \textbf{0.712\,W} (range 0.514--0.771).
