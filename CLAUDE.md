...
- **Green:** 1261 fast + **24** frozen-gate tests (**1285**), `ruff` clean, **`mypy` clean (0 / 49 files)**, paper builds (**15 pp**, **46 refs**, 0 undefined, abstract **265 w**). `make all` exit 0.
